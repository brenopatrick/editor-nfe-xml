...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.load_button = customtkinter.CTkButton(self.header_frame, text="Carregar XML", command=self.load_xml, fg_color="#ff6b9d", hover_color="#E8628D")
        self.load_button.pack(side="left", padx=10, pady=10)

        self.save_button = customtkinter.CTkButton(self.header_frame, text="Salvar XML", command=self.save_xml, fg_color="#ff6b9d", hover_color="#E8628D")
        self.save_button.pack(side="right", padx=10, pady=10)

        # Create tabs
        self.tab_view = customtkinter.CTkTabview(self, width=800, fg_color="#1a1a1a", border_color="#ff6b9d", border_width=2)
